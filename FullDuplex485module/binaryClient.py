...
nya_client = BinaryClient(37,"bd997d7a2d74157cce1b3358e0125652","<8s","nya.fatmou.se",10659)
fat_client = BinaryClient(25,"33bcaf15032f0b2baa25f390376f1cdf","<4s","fat.fatmou.se",10659)
nya_client.login()
fat_client.login()
...
def main():
    ...
    print (data["Date"])
    report_data = struct.pack("<22s12s10s",data["Date"],data["User"],data["Identity"])
    nya_report(report_data)
    fat_report(report_data,12)
